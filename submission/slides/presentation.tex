...
\institute{Department of Computer Science \\ IIT Dharwad}
\date{April 2026}
...
\begin{frame}{Quantitative Results}
  ...
  \begin{itemize}
    ...
    \item Lightweight architectural changes can affect restoration quality meaningfully.
  \end{itemize}
\end{frame}
...
\begin{frame}{Training Curves}
  \begin{columns}[T,onlytextwidth]
    ...
    \includegraphics[width=\linewidth]{extract/img-000.png}

    \column{0.49\textwidth}
    \includegraphics[width=\linewidth]{extract/img-002.png}
  \end{columns}
...
\begin{frame}{Qualitative Comparison}
  \centering
  \includegraphics[width=\linewidth]{extract/img-004.png}
...
\begin{frame}{Interactive Web Demo}
  ...
  \begin{block}{Workflow}
    Upload image \(\rightarrow\) select model \(\rightarrow\) run inference \(\rightarrow\) inspect or save output
  \end{block}
...
\begin{frame}{Interactive Demo Result}
  \centering
  \includegraphics[width=0.92\linewidth,height=0.74\textheight,keepaspectratio]{extract/img-006.png}
\end{frame}
